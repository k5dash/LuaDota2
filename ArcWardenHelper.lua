...
function ArcHelper.cloneAttack()
	...
	if ArcHelper.cloneAttacking then
		...
		if ArcHelper.cloneAttackingTarget then
			...
			if invisible_candidate_blade and Ability.IsReady(invisible_candidate_blade) and ArcHelper.isEnougthMana(ArcHelper.clone, invisible_candidate_blade) then
			...
			if hurrican and Ability.IsReady(hurrican) and ArcHelper.isTarget(ArcHelper.clone,ArcHelper.cloneAttackingTarget, 1800) 
				and not NPC.IsEntityInRange(ArcHelper.cloneAttackingTarget, ArcHelper.clone, 500) and ArcHelper.useHurrican then
			...
			if hex and Ability.IsReady(hex) and not NPC.HasModifier(ArcHelper.cloneAttackingTarget, "modifier_sheepstick_debuff") 
			...
			if hex and Ability.IsReady(hex) and NPC.HasModifier(ArcHelper.cloneAttackingTarget, "modifier_sheepstick_debuff") 
			...
			if Ability.IsReady(magnetic) and not NPC.HasModifier(ArcHelper.clone, "modifier_arc_warden_magnetic_field") 
